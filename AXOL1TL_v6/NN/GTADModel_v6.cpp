...
void GTADModel_v6(
    ...
    GTADModel_v6::dense_da_3<input_t, q_dense_t>(input_2, layer3_out); // q_dense
    ...
    GTADModel_v6::dense_da_7<activation_t, q_dense_1_t>(layer5_out, layer7_out); // q_dense_1
    ...
    GTADModel_v6::dense_da_11<activation_1_t, q_dense_2_t>(layer9_out, layer11_out); // q_dense_2
    ...
    GTADModel_v6::dense_da_15<activation_2_t, q_dense_3_t>(layer13_out, layer15_out); // q_dense_3
    ...
    GTADModel_v6::dense_da_19<activation_3_t, q_dense_4_t>(layer17_out, layer19_out); // q_dense_4

    q_dense_6_t layer21_out[N_LAYER_21];
    #pragma HLS ARRAY_PARTITION variable=layer21_out complete dim=0
    GTADModel_v6::dense_da_21<q_dense_4_t, q_dense_6_t>(layer19_out, layer21_out); // q_dense_6
    ...
    GTADModel_v6::dense_da_25<activation_4_t, q_dense_7_t>(layer23_out, layer25_out); // q_dense_7
    ...
    GTADModel_v6::dense_da_29<activation_5_t, q_dense_8_t>(layer27_out, layer29_out); // q_dense_8
