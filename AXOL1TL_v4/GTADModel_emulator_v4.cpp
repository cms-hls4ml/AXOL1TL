...
using namespace hls4ml_axol1tl_v4;

class GTADModel_emulator_v4 : public hls4mlEmulator::Model {
...
private:
  ...
  virtual void _scaleNNInputs(unscaled_t unscaled[N_INPUT_1_1], input_t scaled[N_INPUT_1_1])
  {
    ...
    {
      unscaled_t tmp0 = unscaled[i] - hls4ml_axol1tl_v4::ad_offsets[i];
      input_t tmp1 = tmp0 >> hls4ml_axol1tl_v4::ad_shift[i];
      scaled[i] = tmp1;
    }
  }
...
public: 
  ...
  virtual void predict() {
    GTADModel_v4(_scaled_input, _result);
...
extern "C" hls4mlEmulator::Model* create_model() {
    return new GTADModel_emulator_v4;
}
