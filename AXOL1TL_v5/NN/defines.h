...
typedef ap_fixed<21,10> q_dense_accum_t;
typedef ap_fixed<21,10> q_dense_t;
typedef ap_fixed<4,1> q_dense_weight_t;
typedef ap_fixed<4,1> q_dense_bias_t;
...
typedef ap_fixed<4,1> q_dense_1_weight_t;
typedef ap_fixed<4,1> q_dense_1_bias_t;
...
typedef ap_fixed<5,2> q_dense_2_weight_t;
typedef ap_fixed<4,1> q_dense_2_bias_t;
...
typedef ap_fixed<5,2> q_dense_3_weight_t;
typedef ap_fixed<4,1> q_dense_3_bias_t;
...
typedef ap_fixed<16,9> q_dense_4_accum_t;
typedef ap_fixed<16,9> q_dense_4_t;
typedef ap_fixed<5,2> q_dense_4_weight_t;
typedef ap_fixed<3,0> q_dense_4_bias_t;
typedef ap_uint<1> layer19_index;
typedef ap_fixed<20,10> q_dense_6_accum_t;
typedef ap_fixed<20,10> q_dense_6_t;
typedef ap_fixed<4,1> q_dense_6_weight_t;
typedef ap_ufixed<3,0> q_dense_6_bias_t;
...
typedef ap_fixed<5,2> q_dense_7_weight_t;
typedef ap_ufixed<3,0> q_dense_7_bias_t;
...
typedef ap_fixed<5,2> q_dense_8_weight_t;
typedef ap_fixed<4,1> q_dense_8_bias_t;
